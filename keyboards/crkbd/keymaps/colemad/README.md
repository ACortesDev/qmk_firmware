...
- Macros: PRTSC, etc...
- Especial Chars:
  - E.g. Spanish (**ñ**, **á**, **é**, **í**, **ó** and **ú**) using the default *English US/International* OS keyboard layout.
...
```
  ...
  `--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------'
                                               ,--------.      ,--------.
                             ,-----------------|        |      |        |-----------------.
                             |   GUI  |  Shift |  Enter |      | Space  |   Ctrl |    Alt |
                             |        |        | (LOWER)|      |(RAISE) |        |        |
                             `--------+--------+--------'      `--------+--------+--------'
```
...
```
  ,-----------------------------------------------------.      ,-----------------------------------------------------.
  |        |        |        |        |        |        |      |RGB_TOG |RGB_MOD |RGB_VAI |RGB_HUI |RGB_SAI |        |
  |--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------|
  |        |        |        |        |        |        |      |        |RGB_RMOD|RGB_VAD |RGB_HUD |RGB_SAD |        |
  |--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------|
  |        |        |        |        |        |        |      |        |        |        |        |        |        |
  `--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------'
                                               ,--------.      ,--------.
